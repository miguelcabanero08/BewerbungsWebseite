      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-0 top-full z-50 mt-2 w-36 overflow-hidden rounded-xl border border-fg/10 bg-surface/95 p-1.5 shadow-xl backdrop-blur-xl md:left-auto md:right-0"
          >
            {LANGUAGES.map((lang) => (
              <button
                key={lang}
